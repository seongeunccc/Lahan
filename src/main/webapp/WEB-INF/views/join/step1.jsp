...
<li>
    <span class="frm frm-chk">
         <input type="checkbox" id="frmChk01" data-valid="Y"><label for="frmChk01">이용 약관에 대한 동의 <span
...
<li>
    <span class="frm frm-chk">
         <input type="checkbox" id="frmChk02" data-valid="Y"><label for="frmChk02">개인 정보 수집•이용에 대한 동의 <span
...
<li>
	<span class="frm frm-chk">
		<input type="checkbox" id="frmChk05" data-valid="Y"><label for="frmChk05">개인정보 제3자제공에 대한 동의 <span class="necessary">(필수)</span></label>
	</span>
	<a href="#none" class="toggle-btnwrap"><span class="toggle-btn"></span></a>
	<div class="toggle-cont" style="display: none;">
		<div class="joinScrollBox">
...
<li>
    <span class="frm frm-chk">
				<input type="checkbox" id="mktCnsgmntAgree">
	...
	<div class="toggle-cont" style="display: none;">
        ...
        <div class="joinBtnArea btn-inline-box">
            <a href="../main.html" title="취소" class="btn btn-navy-line">취소</a>
            <a href="#none" id="nextBtn" onclick="" title="다음(본인인증)" class="btn btn-inactive">다음(본인인증)</a> 
            <!-- 필수 동의체크 시 btn-active 클래스 변경 -->
        </div>
    </div>
</div>
		</div>
			...
			<div class="f-wrap">
				<div class="f-box-top">
					<div class="box-top-inner">
						<ul class="f-nav-list">
                            <li><a href="../hotel/brandIntroduce.html" title="라한 브랜드">라한 브랜드라한 브랜드</a></li>
							<li><a href="../clublahan/membership.html" title="멤버십">멤버십무료멤버십</a></li>
							<li><a href="../notice/generalInfo/list.html" title="공지사항">공지사항공지사항</a></li>
							<li><a href="../customer/contact.html" title="제안/제보">제안/제보고객문의</a></li>
							<li><a href="../ethical/terms.html" title="윤리경영">윤리경영윤리경영</a></li>
							<li><a href="../sitemap.html" title="사이트맵">사이트맵사이트맵</a></li>
						</ul>
						<ul class="f-nav-list">
							<li><a href="../termsUse/terms.html" title="이용약관">이용약관이용약관</a></li>
							<li><a href="../terms/terms.html" title="개인정보처리방침" class="pr-po"><strong>개인정보처리방침개인정보처리방침</strong></a></li>
						</ul>
					</div>
				</div>
							...
							<div class="f-site-info">
								<div class="f-select-wrap select">
									...
									<ul class="f-select-box">
										...
										<li><a href="../../../mokpo/ko/main.html" title="MOKPO" class="option" target="_blank">호텔현대 바이 라한 목포호텔현대 바이 라한 목포</a></li>
										<li><a href="../../../ulsan/ko/main.html" title="ULSAN" class="option" target="_blank">호텔현대 바이 라한 울산호텔현대 바이 라한 울산</a></li>
										<li><a href="../../../pohang/ko/main.html" title="POHANG" class="option" target="_blank">라한호텔 포항라한호텔 포항</a></li>
										<li><a href="../../../jeonju/ko/main.html" title="JEONJU" class="option" target="_blank">라한호텔 전주라한호텔 전주</a></li>
										<li><a href="../../../gyeongju/ko/main.html" title="GYEONGJU" class="option" target="_blank">라한셀렉트 경주라한셀렉트 경주</a></li>
										<li><a href="../main.html" title="LAHAN" class="option" target="_blank">라한라한</a></li>
									</ul>
								</div>

		...
		<header id="header" class="header">
			...
			<div class="h-wrap">
				...
				<div class="h-box-right">
					<ul class="set-wrap">
						...
						<li><a href="step1.html" title="회원가입">회원가입<!-- 회원가입 --></a></li>
						<li><a href="../login/loginForm.html" title="로그인">로그인<!-- 로그인 --></a></li>
                        <li><a href="../login/loginNonMemForm.html" title="예약확인" class="" layer-data="select1">예약확인<!-- 예약확인 --></a></li>   
            ...
            <div class="all-menulist">
				<div class="all-menulist-wrap">
					...
					<ul class="all-1depth">
						<li><a href="../login/loginForm0a54.html" title="마이페이지">마이페이지<!-- 마이페이지 --></a></li>
						<li><a href="../login/loginForm177a.html" title="마이포인트">마이포인트<!-- 마이포인트 --></a></li>
						<li><a href="../login/loginFormc20d.html" title="마이쿠폰">마이쿠폰<!-- 마이쿠폰 --></a></li>
<!--			예약조회/확인			
     <li><a href="#none" title="예약조회/확인">예약조회/확인</a></li>
-->
						<li><a href="../login/loginFormb29f.html" title="개인정보관리/탈퇴">개인정보관리/탈퇴<!-- 개인정보관리/탈퇴 --></a></li>
					</ul>
				</div>
			</div>
...
<li>
	...
	<div class="toggle-cont" style="display: none;">
        ...
        <div class="joinBtnArea btn-inline-box">
            ...
            <a href="#none" id="nextBtn" onclick="" title="다음(본인인증)" class="btn btn-inactive">다음(본인인증)</a> <!-- 필수 동의체크 시 btn-active 클래스 변경 -->
        </div>
    </div>
</div>
		</div>
